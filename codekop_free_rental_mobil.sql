...
--
-- Database: `codekop_free_rental_gadget`
--
...
INSERT INTO `gadget` (`id_gadget`, `no_plat`, `merk`, `harga`, `deskripsi`, `status`, `gambar`) VALUES
...
--
ALTER TABLE `gadget`
  MODIFY `id_gadget` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
