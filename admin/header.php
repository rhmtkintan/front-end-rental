...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | G-Rent </title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar gadget'){ echo 'active';}?>
                <?php if($title_web == 'Tambah gadget'){ echo 'active';}?>
                <?php if($title_web == 'Edit gadget'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/gadget/gadget.php">Daftar Elektronik</a>
                </li>
