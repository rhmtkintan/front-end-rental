 ...
 */
    ...
    if(!empty($_GET['id'])){
        ...
        $sql = "SELECT gadget.merk, booking.* FROM booking JOIN gadget ON 
                booking.id_gadget=gadget.id_gadget WHERE id_login = '$id' ORDER BY id_booking DESC";
    }else{
        $sql = "SELECT gadget.merk, booking.* FROM booking JOIN gadget ON 
                booking.id_gadget=gadget.id_gadget ORDER BY id_booking DESC";
    }
