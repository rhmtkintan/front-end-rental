...
<div id="carouselId" class="carousel slide" data-ride="carousel">
    <ol class="carousel-indicators">
        <?php 
            $querygadget =  $koneksi -> query('SELECT * FROM gadget ORDER BY id_gadget DESC')->fetchAll();
            $no =1;
            foreach($querygadget as $isi)
            {
        ?>
...
<div class="container-fluid mt-5">
    <div class="row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <?php 
                    $query =  $koneksi -> query('SELECT * FROM gadget ORDER BY id_gadget DESC')->fetchAll();
                    $no =1;
                ...
                <div class="col-sm-4">
                    ...
                    <img src="assets/image/<?php echo $isi['gambar'];?>" class="card-img-top" style="height:200px;">
                        ...
                        <div class="card-body">
                        <center><a href="booking.php?id=<?php echo $isi['id_gadget'];?>" class="btn btn-success">Booking now!</a>
                        <a href="detail.php?id=<?php echo $isi['id_gadget'];?>" class="btn btn-info">Detail</a></center>
                        </div>
                    </div>
                </div>
                <?php $no++;}?>
